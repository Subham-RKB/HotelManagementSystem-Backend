...
CREATE TABLE `hotelservices` (
  ...
  KEY `fk_idservice_idx` (`idservice`),
  CONSTRAINT `fk_idhotel` FOREIGN KEY (`idhotel`) REFERENCES `hotels` (`id`),
  CONSTRAINT `fk_idservice` FOREIGN KEY (`idservice`) REFERENCES `services` (`id`)
