...
CREATE TABLE `customerbill` (
  ...
  KEY `fk_customerbillid_idx` (`billid`),
  CONSTRAINT `fk_billcusid` FOREIGN KEY (`cusid`) REFERENCES `customer_credentials` (`id`),
  CONSTRAINT `fk_customerbillid` FOREIGN KEY (`billid`) REFERENCES `bills` (`id`)
