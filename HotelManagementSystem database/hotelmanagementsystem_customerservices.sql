...
CREATE TABLE `customerservices` (
  ...
  KEY `fk_customerserviceid_idx` (`serviceid`),
  CONSTRAINT `fk_customerserviceid` FOREIGN KEY (`serviceid`) REFERENCES `services` (`id`),
  CONSTRAINT `fk_servicecusid` FOREIGN KEY (`cusid`) REFERENCES `customer_credentials` (`id`)
